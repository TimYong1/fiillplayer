...
import com.fiill.fiillplayer.eventbus.FileExplorerEvents;
...
public class FileExplorerActivity extends AppActivity {
    ...
    private void doOpenDirectory(File path, boolean addToBackStack) {
    ...
    public void onClickFile(FileExplorerEvents.OnClickFile event) {
        ...
        if (f.isDirectory()) {
            ...
            FilePlayActivity.intentTo(this, f.getPath(), f.getName());
        }
    }
}
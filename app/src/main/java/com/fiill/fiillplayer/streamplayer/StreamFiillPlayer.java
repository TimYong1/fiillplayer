...
import com.fiill.fiillplayer.activities.StreamPlayerActivity;
import com.fiill.fiillplayer.application.Settings;
...
/**
 * This is the core for stream playing.
 */

public class StreamFiillPlayer implements MediaController.MediaPlayerControl {
    public static final String TAG = "StreamFiillPlayer";
    public static final String ACTION = "com.fiill.Fiillplayer.action";
    ...
    private StreamFiillPlayer(final Context context, final VideoInfo videoInfo) {
        this.context = context.getApplicationContext();
        this.videoInfo = videoInfo;
        log("new StreamFiillPlayer");
        ...
        internalPlaybackThread = new HandlerThread("FiillplayerInternal:Handler", Process.THREAD_PRIORITY_AUDIO);
                ...
                switch (msg.what) {
                    case MSG_CTRL_PLAYING:
                        if (currentState == STATE_ERROR) {
                            ...
                            mediaPlayer.start();
                            //RecentMediaStorage.saveUrlAsync(getActivity(),
                             //       videoInfo.getUri().toString());
     ...
     */
    private StreamFiillPlayer setVideoPath(String path) throws IOException {
     ...
     */
    private StreamFiillPlayer setVideoURI(Uri uri) throws IOException {
     ...
     */
    private StreamFiillPlayer setVideoURI(Uri uri, Map<String, String> headers) throws IOException {
        this.uri = uri;
        this.headers.clear();
    ...
    private void init(boolean createDisplay) {
        ...
        uiHandler.post(new Runnable() {
            @Override
            public void run() {
                proxyListener().onPreparing(StreamFiillPlayer.this);
            }
        });
        releaseMediaPlayer();
        ...
        try {
            ...
            uiHandler.post(new Runnable() {
                @Override
                public void run() {
                    proxyListener().onError(StreamFiillPlayer.this, 0, 0);
                }
            });
        }
        ...
        mediaPlayer.setOnPreparedListener(new IMediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(IMediaPlayer iMediaPlayer) {
                if (!TextUtils.isEmpty(uri.toString())) {
                    RecentMediaStorage.saveUrlAsync(getActivity(), uri.toString());
                }
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        proxyListener().onPrepared(StreamFiillPlayer.this);
        ...
        mediaPlayer.setOnBufferingUpdateListener(new IMediaPlayer.OnBufferingUpdateListener() {
            ...
            public void onBufferingUpdate(IMediaPlayer iMediaPlayer, int percent) {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        proxyListener().onBufferingUpdate(StreamFiillPlayer.this, percent);
                    }
                });
            }
        });
            ...
            public boolean onInfo(IMediaPlayer iMediaPlayer, int what, int extra) {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ret[0] =  proxyListener().onInfo(StreamFiillPlayer.this, what, extra);
                    }
                });
                return ret[0];
            }
            ...
            public void onCompletion(IMediaPlayer iMediaPlayer) {
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        proxyListener().onCompletion(StreamFiillPlayer.this);
                    }
                });
            }
        });
        mediaPlayer.setOnErrorListener(new IMediaPlayer.OnErrorListener() {
            ...
            public boolean onError(IMediaPlayer iMediaPlayer, int what, int extra) {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        currentState(STATE_ERROR);
                        ret[0] = proxyListener().onError(StreamFiillPlayer.this, what, extra);
        ...
        mediaPlayer.setOnSeekCompleteListener(new IMediaPlayer.OnSeekCompleteListener() {
            ...
            public void onSeekComplete(IMediaPlayer iMediaPlayer) {
                getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        proxyListener().onSeekComplete(StreamFiillPlayer.this);
                    }
                });
            }
        });
            ...
            public void onVideoSizeChanged(final IMediaPlayer mp, int width, int height, int sarNum, int sarDen) {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (currentDisplay != null &&
                                currentDisplay instanceof IScalableDisplay) {
        ...
        mediaPlayer.setOnTimedTextListener(new IMediaPlayer.OnTimedTextListener() {
            ...
            public void onTimedText(IMediaPlayer mp, IjkTimedText text) {
                getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        proxyListener().onTimedText(StreamFiillPlayer.this, text);
                    }
                });
            }
        });
    ...
    public static StreamFiillPlayer createPlayer(Context context, VideoInfo videoInfo) {
        return new StreamFiillPlayer(context, videoInfo);
    }

    private StreamFiillPlayer bindDisplay(final TextureView textureView) {
     ...
     * @param container
     */
    public StreamFiillPlayer createDisplay(final ViewGroup container) {
     ...
     * @return
     */
    private StreamFiillPlayer isolateDisplayBoxContainer() {
     ...
     * @return
     */
    private StreamFiillPlayer isolateDisplayBox() {
     ...
     * @return
     */
    public StreamFiillPlayer toggleFullScreen() {
    ...
    public StreamFiillPlayer setDisplayModel(int targetDisplayModel) {
    ...
    public StreamFiillPlayer doMessage(Message message) {
        handler.sendMessage(message);
        return this;
    }


    public void lazyLoadProgress(final int progress) {
        uiHandler.post(new Runnable() {
            @Override
            public void run() {
                proxyListener().onLazyLoadProgress(StreamFiillPlayer.this, progress);
            }
        });
    }
    ...
    public void lazyLoadError(final String message) {
        uiHandler.post(new Runnable() {
            @Override
            public void run() {
                proxyListener().onLazyLoadError(StreamFiillPlayer.this, message);
            }
        });
    }
...
//                    must put the action to queue so the beginDelayedTransition can take effect
    ...
    private ViewGroup createFloatBox() {
        ...
        ViewGroup floatBox = (ViewGroup) LayoutInflater.from(topActivity.getApplication()).inflate(R.layout.fiill_float_box, null);
        floatBox.setBackgroundColor(videoInfo.getBgColor());
        DisplayMetrics displayMetrics=new DisplayMetrics();
        getActivity().getWindowManager().getDefaultDisplay().getMetrics(displayMetrics);
        int widthPixels = displayMetrics.widthPixels / 2;
        int heightPixels =  widthPixels * 3 / 4;

        FrameLayout.LayoutParams floatBoxParams = new FrameLayout.LayoutParams(widthPixels, heightPixels);
        if (VideoInfo.floatView_x == Integer.MAX_VALUE || VideoInfo.floatView_y == Integer.MAX_VALUE) {
            ...
            floatBoxParams.bottomMargin = displayMetrics.widthPixels / 6;
            floatBoxParams.rightMargin = displayMetrics.heightPixels / 12;
        } else {
...
//                            x = 0;
    ...
    public StreamFiillPlayer onConfigurationChanged(Configuration newConfig) {
...
//        }
    ...
    public static void play(Context context, VideoInfo videoInfo) {
        Intent intent = new Intent(context, StreamPlayerActivity.class);
    ...
    public StreamFiillPlayer selectTrack(int track) {
        if (mediaPlayer == null || released) {
            return this;
        }
    ...
    public StreamFiillPlayer deselectTrack(int selectedTrack) {
        if (mediaPlayer == null || released) {
            return this;
        }
     ...
     * @return Fiillplayer
     */
    public StreamFiillPlayer setVolume(float left, float right) {
        if (mediaPlayer == null || released) {
            return this;
        }
     ...
     * @return Fiillplayer
     */
    public StreamFiillPlayer setMute(boolean mute) {
        this.mute = mute;
     ...
     * @return
     */
    public StreamFiillPlayer setLooping(boolean looping) {
        if (mediaPlayer != null && !released) {

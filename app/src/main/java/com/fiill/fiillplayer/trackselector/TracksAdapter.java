...
public class TracksAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.fiill_track_selector_group, parent, false);
        }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.fiill_track_selector_child, parent, false);
            convertView.findViewById(R.id.app_video_track_group_child).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (trackGroup.getSelectedTrackIndex() != track.getIndex()) {
                        ...
                        StreamFiillPlayer player = PlayerManager.getInstance().getPlayerByFingerprint(track.getFingerprint());
                        if (player != null) {
                            if (track.getIndex() >= 0) {
    ...
    public void load(String fingerprint) {
        ...
        StreamFiillPlayer player = PlayerManager.getInstance().getPlayerByFingerprint(fingerprint);
        if (player == null) {
            return;
        }
        dataIndex.clear();

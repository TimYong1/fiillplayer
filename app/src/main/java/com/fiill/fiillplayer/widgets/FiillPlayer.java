...
/*
 * This player is for file explorer.
 */
public class FiillPlayer {
    /**
    ...
    private final FiillVideoView videoView;
    ...
    public FiillPlayer(final Activity activity) {
        try {
            IjkMediaPlayer.loadLibrariesOnce(null);
            IjkMediaPlayer.native_profileBegin("libijkplayer.so");
            playerSupport=true;
        } catch (Throwable e) {
            Log.e("FiillPlayer", "loadLibraries error", e);
        }
        this.activity=activity;
        screenWidthPixels = activity.getResources().getDisplayMetrics().widthPixels;
        $=new Query(activity);
        videoView = (FiillVideoView) activity.findViewById(R.id.fiill_video_view);
    ...
    private void statusChange(int newStatus) {
        ...
        if (!isLive && newStatus==STATUS_COMPLETED) {
            ...
            if (!TextUtils.isEmpty(url)) {
                RecentMediaStorage.saveUrlAsync(activity, url);
            }
            hideAll();
        }
    ...
    /**
     * using constants in FiillPlayer,eg: FiillPlayer.SCALETYPE_FITPARENT
     * @param scaleType
     */
    public void setScaleType(String scaleType) {
        if (SCALETYPE_FILLPARENT.equals(scaleType)) {
     ...
     */
    public FiillPlayer seekTo(int msec, boolean showControlPanle){
    ...
    public FiillPlayer forward(float percent) {
    ...
    public FiillPlayer playInFullScreen(boolean fullScreen){
        if (fullScreen) {
            activity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
            updateFullScreenButton();
        }
    ...
    public FiillPlayer onError(OnErrorListener onErrorListener) {
        this.onErrorListener = onErrorListener;
        return this;
    }

    public FiillPlayer onComplete(Runnable complete) {
        this.oncomplete = complete;
        return this;
    }

    public FiillPlayer onInfo(OnInfoListener onInfoListener) {
        this.onInfoListener = onInfoListener;
        return this;
    }

    public FiillPlayer onControlPanelVisibilityChang(OnControlPanelVisibilityChangeListener listener){
     ...
     * @return
     */
    public FiillPlayer live(boolean isLive) {
        this.isLive = isLive;
        return this;
    }

    public FiillPlayer toggleAspectRatio(){
        if (videoView != null) {
            videoView.toggleAspectRatio();
        }
        return this;
    ...
    public FiillPlayer onControlPanelVisibilityChange(OnControlPanelVisibilityChangeListener listener){
        this.onControlPanelVisibilityChangeListener = listener;
        return this;
    }
